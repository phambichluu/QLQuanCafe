...
namespace QLQuanCafe.Controllers
{
    public class ThanhToansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaTT,NgayTT,MaNV,MaKH,ThanhTien")] ThanhToan thanhToan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaTT,NgayTT,MaNV,MaKH,ThanhTien")] ThanhToan thanhToan)
        {
            if (ModelState.IsValid)
            {
